...
- [x] **LOAN-01**: 관리자가 대출 만기를 연장할 수 있다 (새 만기일, 금리 변경 가능)
...
- [x] **LOAN-08**: 매일 자동으로 연체 상태가 업데이트된다 (일괄 연체 처리)
- [x] **LOAN-09**: 관리자가 수동으로 연체 일괄 처리를 실행할 수 있다
- [x] **LOAN-10**: 일괄 연체 처리가 트랜잭션 내에서 원자적으로 실행된다
...
| LOAN-08 | Phase 3 | Complete |
| LOAN-09 | Phase 3 | Complete |
| LOAN-10 | Phase 3 | Complete |
